...
class TestAuv2(unittest.TestCase):
    ...
    def test_calculate_auv_acceleration(self):
        ...
        npt.assert_array_almost_equal(up.calculate_auv2_acceleration(self.testTorque, np.pi/4 , np.pi/4, 15),[1.6066667, -0.5133333],  decimal = 7)
        testTorque1 = [-13.2, 12.76, 10, -18.4]
        npt.assert_array_almost_equal(up.calculate_auv2_acceleration(testTorque1, np.pi/5 , np.pi / 3, 15),[2.0594091, -0.6932663],  decimal = 7)
